...
public:
    ...
    Orders() : order_id(""), order_date(Date()), order_time(0) {
        // Default constructor implementation
    }
    virtual ~Orders();
    Orders(const Orders& other_order){
        this->order_id = other_order.order_id;
        this->order_date = other_order.order_date;
        this->order_time = other_order.order_time;
    }
